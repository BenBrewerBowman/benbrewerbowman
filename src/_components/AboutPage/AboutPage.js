...
const AboutPage = (props) => (
    ...
    <div id={props.id} > 
                ...
                <Grid item xs={12} md={6} style={styles.centerChildren} >
                    <div style={styles.centerChildren} >
                        ...
                        <p style={styles.content}>  
                            ...
                            Largest elevation drop mountain biking: 6500 feet 
                            Longest distance mountain biking: 34 miles
                            <br/>
                            <br/>
        ...
        <Particles 
            ...
            width='100%'
          />
        <div style={{marginTop: -50, height: 400}} >
            ...
            <div style={{ display: 'flex', flexDirection: 'row-reverse', marginRight: '15%' }} >
                <svg style={{marginTop: 80, transform: 'rotate(-45deg)'}} width="300" enable-background="new 0 0 389.722 229.551" viewBox="0 0 389.722 229.551" xmlns="http://www.w3.org/2000/svg">
