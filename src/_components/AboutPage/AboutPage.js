...
const AboutPage = (props) => (
    ...
    <div id={props.id} > 
                ...
                <Grid item xs={12} md={6} style={styles.centerChildren} >
                    ...
                    <h1 style={styles.header}> Hey! I'm Ben </h1>
                        <h3 style={styles.content}>  
                            ...
                            I graduated Summa Cum Laude in Mechatronics Engineering from UNC Asheville, and shortly thereafter relocated to Salt Lake City, UT.
                            I am an avid snowboarder, mountain biker, and backpacker, and enjoy just about anything outdoors.
                        </h3>
                    </div>
                </Grid>
            </Grid>
        ...
        <Particles 
            ...
            // background: 'linear-gradient(to top, #5DDFED 65%, Whitesmoke)',
            width: '100%',
            clipPath: 'polygon(0 0, 100% 15%, 100% 80%, 85% 50%, 60% 100%, 40% 60%, 25% 90%, 20% 80%, 15% 90%, 0 60%)',
            zIndex: -1,
            position: 'absolute', 
            marginTop: -50,
            }}
            ...
            width='100%'
          />
        <div style={{marginTop: -50, height: 500}} >
